...
print("PERMANENT ACCESS MAUJ KAATOOOO")
import requests
import uuid
import time
import random
...
logo = render('AYUSH', font='block', colors=['cyan', 'white'], align='left', space=True)
print("\x1b[1;39m\u2014" * 60)
print(logo)      
print("\x1b[1;39m\u2014" * 60)
...
print('AYUSH TOOLS OPEN HO RAHA.......')

def display():
    stats = f"\r +hits: {hits}  +good: {good}  -bad: {bad}  email: {email}"
...
AYUSH HIGH POST TOOLS AND HIGH FOLLOWERS 
...
def get_usernames():
    ...
    while True:
        try:
            ...
            if username and pk_id and followers and followers > 40:
